...
export var saltContent = function(content) {
  var c, cBuf, contentLength, end, fullLength, idx, j, len, overlap, padding, prefixLength, resultBuffer, salt, saltLength, sum, unpaddedLength;
...
// immediatly write the content to the resultBuffer
  for (idx = j = 0, len = cBuf.length; j < len; idx = ++j) {
    c = cBuf[idx];
...
export var unsaltContent = function(contentBuffer) {
  var bufLen, end, idx, start, sum;
  sum = 0;
  idx = 32;
